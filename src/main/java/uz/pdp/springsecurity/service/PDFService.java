...
public class PDFService {
    ...
    public void createPdf(Trade trade, HttpServletResponse response) throws IOException {
        ...
        Currency currency = currencyRepository.findByBusinessIdAndActiveTrue(trade.getBranch().getBusiness().getId());
        type = currency.getDescription();
...
//        }
    ...
    public void createPdfPurchase(Purchase purchase, HttpServletResponse response) throws IOException {
        ...
        Paragraph customer = new Paragraph();
        Text custValue = new Text(purchase.getSupplier().getName());
        ...
        Text phoneValue = new Text(purchase.getSupplier().getPhoneNumber());
